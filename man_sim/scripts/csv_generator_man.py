...
def generate_CSV(pop_parameters,infection_parameters,filepath):
    ...
    ethn = {'white':pop_parameters['white'],'black':pop_parameters['black'],'asian':pop_parameters['asian'],'other':pop_parameters['other']}
    gen = {'male':pop_parameters['male'],'female':pop_parameters['female']}
    ag = {'child':pop_parameters['child'],'adult':pop_parameters['adult'],'senior':pop_parameters['senior']}
